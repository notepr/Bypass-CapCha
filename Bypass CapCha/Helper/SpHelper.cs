...
namespace Bypass_CapCha.Helper
{
    public class DeviceInfo
    {
        ...
        public System.Drawing.Rectangle MonitorArea { get; set; }
    }
        ...
        private static bool MonitorEnum(IntPtr hMonitor, IntPtr hdcMonitor, ref Rect lprcMonitor, IntPtr dwData)
        {
            ...
            if (success)
            {
                ...
                var di = new DeviceInfo
                {
                    ...
                    MonitorArea = new System.Drawing.Rectangle(mi.Monitor.left, mi.Monitor.top, mi.Monitor.right - mi.Monitor.right, mi.Monitor.bottom - mi.Monitor.top),
